...
groupsAnfis=[ones(size(featurs_L1,2),1)  ;-10*ones(size(featurs_L2,2),1);10*ones(size(featurs_L3,2),1);
         -1*ones(size(featurs_At,2),1) ;50*ones(size(featurs_Normal,2),1) ;-50*ones(size(featurs_Re,2),1)];
